...
import { AlertTriangle, Info, Sparkles, ExternalLink } from 'lucide-react';
        ...
        <Card>
          ...
          <CardContent>
            <Alert>
              ...
              <AlertDescription>
                Please create an API key in the <a href="/dashboard/api-keys" className="underline font-semibold">API Keys page</a> first.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
    ...
    <div className="container max-w-4xl py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Test the live payment flow before integrating into your site
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {showWarning && (
            <Alert className="border-amber-500 bg-amber-50">
              ...
              <AlertDescription className="text-amber-900">
                <strong>IMPORTANT:</strong> This uses REAL cryptocurrency with SideShift's live API. 
                SideShift has no sandbox environment. Transactions will:
          ...
          <Alert>
            <Info className="h-4 w-4" />
            <AlertDescription>
              We recommend starting with $1-2 for your first try. Once you verify the flow works, 
              you can test with slightly larger amounts (up to ${MAX_TRY_AMOUNT}). Your branding and 
              customization from Settings will appear in the widget.
            </AlertDescription>
          </Alert>
          ...
          <Button 
            onClick={handleTry} 
            disabled={loading || parseFloat(amount) > MAX_TRY_AMOUNT || !apiKey}
            className="w-full"
            size="lg"
          >
          ...
          <div className="pt-4 border-t">
            <p className="text-sm text-muted-foreground">
              <strong>Using API Key:</strong> <code className="font-mono text-xs bg-slate-100 px-2 py-1 rounded">{apiKey.substring(0, 20)}...</code>
            </p>
          </div>
        </CardContent>
      </Card>
