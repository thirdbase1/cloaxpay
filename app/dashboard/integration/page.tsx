    ...
    <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
      ...
      <Alert className="bg-emerald-50 border-emerald-200">
        ...
        <AlertDescription className="text-emerald-900">
          <strong>Works Everywhere:</strong> Our payment widget works on any platform that can open a URL - websites,
          mobile apps (iOS/Android), desktop apps, or any system with web capabilities.
        </AlertDescription>
      </Alert>
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="p-3 sm:p-4 rounded-lg bg-muted/50 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Your wallet is where all payments are settled. We need it before generating API keys so payments have
                somewhere to go. Go to{" "}
                <Link href="/dashboard/settings" className="text-primary underline">
                  Settings → Wallets
                </Link>
                .
