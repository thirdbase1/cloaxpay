      ...
      <section className="relative py-16 sm:py-24 md:py-32 lg:py-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative">
          <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-balance animate-in fade-in slide-in-from-bottom-6 duration-700">
              Get Paid in
              <span className="text-primary"> Any Chain.</span>
              <br />
              Receive in
              <span className="text-primary"> Any Token You Choose.</span>
            </h1>

            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto text-balance leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100 px-2">
              Your customers pay with <span className="text-foreground font-semibold">200+ cryptocurrencies</span>{" "}
              across <span className="text-foreground font-semibold">40+ blockchains</span>. We auto-convert and send it
              directly to your wallet in your preferred token.{" "}
              <span className="text-primary font-semibold">Zero fees. Truly decentralized. Non-custodial.</span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center pt-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300 max-w-md mx-auto sm:max-w-none">
              <Link href="/auth/sign-up" className="w-full sm:w-auto">
                ...
                >
                  Start Accepting Crypto <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </Button>
              </Link>
              <Link href="/dashboard/try-widget" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  variant="outline"
